/*! * fixHeader 1.0.0 * Copyright 2012 chokobo * * make table header fixed * * notice： set th,id border-width in IE * * tested browser: IE7 IE8 firefox16.0
chrome22.0 */
(function($, undefined) {
